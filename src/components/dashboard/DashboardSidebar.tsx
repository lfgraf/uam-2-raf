...
export function DashboardSidebar({ isOpen, onClose, isCollapsed, onToggleCollapse }: DashboardSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={cn(
        "fixed top-0 left-0 h-full bg-white dark:bg-graphite-900 border-r border-gray-200 dark:border-graphite-700 z-50 transform transition-all duration-300 ease-in-out",
        ...
        <div className="flex flex-col h-full">
          {/* Header */}
          <div className={cn(
            "flex items-center border-b border-gray-200 dark:border-graphite-700 p-6",
            ...
            <button
              ...
              className="hidden lg:block p-1 hover:bg-gray-100 dark:hover:bg-graphite-850 rounded text-gray-900 dark:text-graphite-100"
          ...
          <div className={cn(
            "p-4 border-t border-gray-200 dark:border-graphite-700",
            isCollapsed && "hidden"
          )}>
