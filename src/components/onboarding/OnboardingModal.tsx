        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="w-12 h-12 bg-bg-muted rounded-xl flex items-center justify-center">
            ...
            <h3 className="text-xl font-medium text-fg-default mb-2">
              Advertiser
            </h3>
            ...
            <div className="flex flex-wrap gap-2">
              <span className="text-xs px-2 py-1 bg-bg-muted text-fg-muted rounded">
                Campaign Management
              </span>
              <span className="text-xs px-2 py-1 bg-bg-muted text-fg-muted rounded">
                Analytics
